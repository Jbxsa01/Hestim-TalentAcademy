    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-4 border-t border-border-subtle flex items-center justify-between gap-3">
          ...
          >
            <div className={`w-6 h-6 rounded-full flex items-center justify-center font-black text-[8px] uppercase tracking-tighter flex-shrink-0 text-white bg-accent/10 text-accent group-hover:bg-accent/20 transition-all`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to={`/talent/${talent.id}`}
              className={`text-[10px] font-black uppercase tracking-[0.2em] transition-all flex-shrink-0 italic text-primary hover:text-accent`}
            >
              Lancer →
            </Link>
          </div>
